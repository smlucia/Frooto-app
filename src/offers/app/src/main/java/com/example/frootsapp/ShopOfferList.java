...
public class ShopOfferList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_shop_offer_list);
...
//                ActivityOptionsCompat options = ActivityOptionsCompat.makeSceneTransitionAnimation(ShopProductList.this, ViewCompat.getTransitionName());
        ...
        adapter = new FirestoreRecyclerAdapter<Offer, ShopOfferList.OffersViewHolder>(options) {

            @NonNull
            @Override
            public ShopOfferList.OffersViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
                View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_listoffer, parent, false);
                return new ShopOfferList.OffersViewHolder(view);
            }
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                switch (menuItem.getItemId()) {
                    case R.id.nav_home:
                        ...
                        Intent intent = new Intent(ShopOfferList.this, ShopOfferList.class);
                        startActivity(intent);
                        break;

                    case R.id.nav_Profile:
                        startActivity(new Intent(ShopOfferList.this, ShopProfileActivity.class));
                        break;
                    case R.id.nav_pending_orders:
                        startActivity(new Intent(ShopOfferList.this, ShopOrderList.class));
                        break;
                    case R.id.nav_logout:
                        FirebaseAuth.getInstance().signOut();
                        Toast.makeText(ShopOfferList.this, "Logged Out", Toast.LENGTH_SHORT).show();
                        startActivity(new Intent(ShopOfferList.this, LoginActivity.class));
                        break;
    ...
    public void navigateAddOffer() {
        Intent intent_1 = new Intent(this, AddOfferActivity.class);
